...
// tl.from('.slides', { duration: 1.25, x: '100%' })
// tl.from('.title', { duration: 1.5, opacity: 0 })
// tl.from('.content', { duration: 1.5, opacity: 0 }, '-=1.5')
// tl.from('.abv', { duration: 1.5, opacity: 0 }, '-=1.5')
// tl.from('.redRec', { duration: 1, x: '100%' }, '-=1')
// tl.from('.beer', { duration: 1.5, x: '100%', opacity: 0 }, '-=0.5')
